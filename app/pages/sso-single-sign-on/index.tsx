                                    ...
                                    children: [
                                        {
                                            ...
                                            bullets: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    subtitle: "An identity provider (Google) would return an access and ID token which a service provider (the application) can use to request resources such as learning about a user's name.",
                                                    bulletImage: {
